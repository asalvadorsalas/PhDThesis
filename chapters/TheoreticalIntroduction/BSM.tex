...
The Froggat-Nielsen mechanism can give rise to new decay channels and processes. The flavon can be produced in top-quark FCNC decays such as the $t\to uX$ and $t\to cX$ processes. Since the flavon has larger couplings to third-generation quarks, the $t\to cX$ is more relevant for masses below 200~GeV, with the dominant decay mode $X\to b\bar{b}$. Figure~\ref{BSM:flavon} shows the top-quark branching ratios involving the flavon, $t\to cX$ and $t\to uX$, and the flavon branching rations for decays to quarks.
