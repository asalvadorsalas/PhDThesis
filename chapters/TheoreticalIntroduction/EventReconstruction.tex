...
\begin{figure}[htbp]
    ...
    \begin{center}
        ...
        \caption{
        Identification efficiency for $b$-jets (a), and rejection rate for (b) $c$-jets and (c) light-jets for the MV2c10 and DL1 taggers as a function of \pT\ in a simulated \ttbar sample~\cite{taggingeff}.
    }
