...
The instantaneous luminosity~\cite{luminosity} is another of the main characteristics of a particle collider, which for the \acrshort{LHClabel} can be approximated to
