...
Table~\ref{tabLHC:LHCparameters} presents a summary of some \acrshort{LHClabel} operation parameters during Run~1 and Run~2.
...
\begin{figure}[htbp]
    ...
    \caption{
        Schematic view of the \acrshort{ATLASlabel} Inner Detector (a) and detaileds of the barrel section (b)~\cite{Collaboration_2008}. 
    }
...
\begin{figure}[htbp]
    \RawFloats
    \begin{center}
    \includegraphics[width=1.0\textwidth]{ATLASLHC/magnetSystems.png}
    \caption{
