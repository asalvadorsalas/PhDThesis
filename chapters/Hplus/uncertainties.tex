...
The uncertainties associated to jets are the most relevant experimental sources in this analysis. The uncertainties on the jet energy scale and resolution add up to 31 and 9 nuisance parameters, respectively~\cite{ATLAS_Collaboration2020-wc,Aaboud_2020}. While individual components of these uncertainties typically lie within the 1\%-5\% range, the analysis focuses on events featuring a large number of jets, where the impact of these uncertainties is significant.\\
