...
To cover the differences between the choice of the four or five flavour schemes, the nominal (5FS) sample is compared to a \textsc{PowhegBoxRes}+\PYTHIA 8 (4FS) \ttb\ sample. This uncertainty is only applied to the \ttb\ component and only the shape effects are extracted.\\
